...
TRAINING_OUTPUT_FILE = Path('lyrics_training_output.json')
TEST_PRED_FILE = Path('lyrics_test_predictions.json')
TEST_RESULT_FILE = Path('lyrics_test_results.json')
...
fig.suptitle("Lyrics Training Report (3-Fold Cross Validation)", fontsize=18)
...
OUTPUT_IMAGE_FILE = Path(f'lyrics_training_metrics_lr_{lr_str}.png')
...
print(f"歌词模型报告已生成：{OUTPUT_IMAGE_FILE}")